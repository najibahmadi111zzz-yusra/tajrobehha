...
public class ChatActivity extends Activity {
    ...
    // بعداً Publishable Key خودت را اینجا قرار بده
    ...
    private void deleteSupabaseFile(
        ...
        new Thread(() -> {
            ...
            try {
                ...
                // فقط بخش مسیر را decode می‌کنیم
